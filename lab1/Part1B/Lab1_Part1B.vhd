...
begin
	...
	y_D(0) <= NOT(y_D(1) OR y_Q(2) OR y_Q(3) OR y_Q(4) OR y_D(5) OR y_Q(6) OR y_Q(7) OR y_Q(8)); -- the D's are used to change on the correct clock cylce
	...
	A: D_FlipFlop PORT MAP(clock, notrestIn, notrestIn, y_Q(0));
	--A: D_FlipFlop PORT MAP(clock, y_D(0), '1', y_Q(0));
